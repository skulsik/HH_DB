...
def main():
    ...
    while command != 'exit':
        ...
        command = input('Команды для работы с программой:\n'
                        ...
                        'all_vacancies - выводит список всех вакансий с указанием названия компании, названия вакансии и зарплаты и ссылки на вакансию.\n'
                        'get_companies - выводит список всех компаний и количество вакансий у каждой компании.\n'
                        'average_salary - выводит среднюю зарплату по вакансиям.\n'
                        'higher_salary - выводит список всех вакансий, у которых зарплата выше средней по всем вакансиям.\n'
                        'vacancies_keyword - выводит список всех вакансий, в названии которых содержатся переданные в метод слова, например “python”.\n'
                        'Введите команду:')
